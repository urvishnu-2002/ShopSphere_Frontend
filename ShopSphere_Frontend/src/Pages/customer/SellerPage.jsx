...
const StepCard = ({ step, title, description, icon: Icon }) => (
    ...
    >
        ...
        <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-indigo-50/50 to-violet-50/50 rounded-bl-[100px] -mr-10 -mt-10 group-hover:scale-110 transition-transform duration-500" />

        <div className="relative z-10">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-indigo-600 to-violet-600 flex items-center justify-center text-white mb-6 shadow-lg shadow-indigo-200 group-hover:rotate-6 transition-transform duration-300">
                <Icon size={32} />
            </div>

            <div className="flex items-center gap-2 mb-3">
                <span className="text-[10px] font-black text-indigo-500 uppercase tracking-[3px] px-3 py-1 bg-indigo-50 rounded-full">
                    Step {step}
                </span>
            </div>

            <h3 className="text-xl font-black text-gray-900 mb-3 tracking-tight group-hover:text-indigo-600 transition-colors">
                {title}
            </h3>
...
const SellerLanding = () => {
    ...
    return (
        <div className="min-h-screen bg-[#FCFBFA] selection:bg-indigo-100 selection:text-indigo-900">
            {/* 1️⃣ HERO SECTION */}
            <section className="relative overflow-hidden pt-12 pb-20 lg:pt-24 lg:pb-32">
                {/* Visual Backdrop */}
                <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-to-br from-indigo-100/40 to-violet-100/40 rounded-full blur-3xl -mr-64 -mt-64" />
                <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-gradient-to-tr from-orange-100/30 to-rose-100/30 rounded-full blur-3xl -ml-32 -mb-32" />
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <motion.div
                                ...
                                className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-50 text-indigo-600 text-xs font-black uppercase tracking-[2px] rounded-full mb-8 border border-indigo-100"
                            >
                            ...
                            <div className="flex flex-col sm:flex-row gap-5">
                                <motion.button
                                    ...
                                    className="px-10 py-5 bg-gradient-to-r from-indigo-600 to-violet-600 text-white rounded-[24px] font-black text-lg shadow-xl shadow-indigo-200 flex items-center justify-center gap-3 group transition-all duration-300"
                                >
                                    Start Selling
                                    <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
                                </motion.button>

                                <button className="px-10 py-5 bg-white text-gray-900 border-2 border-gray-100 hover:border-indigo-100 hover:bg-gray-50 rounded-[24px] font-black text-lg transition-all duration-300">
                                    Explore Benefits
                                </button>
                            </div>
                        ...
                        >
                            <div className="relative z-10 bg-white/40 backdrop-blur-xl p-6 rounded-[56px] border border-white shadow-2xl overflow-hidden">
                                <div className="bg-gradient-to-br from-indigo-50 to-violet-50 rounded-[48px] p-8 aspect-[4/3] flex items-center justify-center relative overflow-hidden">
                                    {/* Abstract background elements */}
                                    <div className="absolute top-0 right-0 w-64 h-64 bg-indigo-400 opacity-20 rounded-full blur-3xl" />
                                    <div className="absolute bottom-0 left-0 w-64 h-64 bg-violet-400 opacity-20 rounded-full blur-3xl" />
                                    ...
                                    <div className="relative z-10 flex flex-col items-center gap-10">
                                        ...
                                        >
                                            <div className="w-full h-full bg-gradient-to-br from-indigo-600 to-violet-600 rounded-[30px] flex items-center justify-center text-white shadow-inner">
                                        ...
                                        <div className="flex gap-6">
                                            ...
                                            <motion.div
                                                ...
                                                className="w-28 h-14 bg-white rounded-2xl shadow-xl border border-gray-50 flex items-center justify-center text-indigo-600"
                                            >
                                                <Award size={28} />
                                            </motion.div>
                                        </div>
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="text-center mb-20">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="text-xs font-black text-indigo-600 uppercase tracking-[4px] mb-4 bg-indigo-50 inline-block px-4 py-2 rounded-full"
                        >
                            Step-by-Step Guide
                        </motion.div>
                        <motion.h2
                        ...
                        >
                            How to sell on <span className="text-indigo-600">ShopSphere?</span>
                        </motion.h2>
                    </div>
            ...
            <section className="py-24 bg-[#FCFBFA]">
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="bg-gray-900 rounded-[56px] p-12 lg:p-24 relative overflow-hidden text-center lg:text-left">
                        ...
                        <div className="absolute top-0 right-0 w-[500px] h-full bg-indigo-600/10 skew-x-12 translate-x-32" />
                        <div className="absolute bottom-0 left-0 w-64 h-64 bg-violet-600/10 rounded-full blur-3xl -ml-20 -mb-20" />
                        ...
                        <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center">
                            <div>
                                ...
                                >
                                    Get Started Now
                                    <CheckCircle2 size={24} className="text-indigo-600 group-hover:scale-110 transition-transform" />
                                </motion.button>
                            </div>
