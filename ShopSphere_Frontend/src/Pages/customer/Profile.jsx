...
function Profile() {
        ...
        <div className="animate-in fade-in slide-in-from-right duration-500 bg-white rounded-[32px] p-8 lg:p-12 shadow-sm border border-gray-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-violet-50 p-6 rounded-3xl flex items-center gap-5 transition-all duration-300">
                    <div className="min-w-[56px] min-h-[56px] bg-white rounded-2xl flex items-center justify-center text-violet-600 shadow-sm border border-violet-100">
                ...
                <div className="bg-purple-50 p-6 rounded-3xl flex items-center gap-5 transition-all duration-300">
                    <div className="min-w-[56px] min-h-[56px] bg-white rounded-2xl flex items-center justify-center text-purple-500 shadow-sm border border-purple-100">
                        <FaCheckCircle size={20} />
                    </div>
                    <div>
                        <p className="text-[10px] text-purple-500 font-black uppercase tracking-[2px] mb-0.5">Status</p>
                        <p className="text-base font-bold text-purple-900">Verified User</p>
                    </div>
                </div>
    ...
    const WishlistTab = () => (
        <div className="animate-in fade-in slide-in-from-right duration-500 h-[600px] flex flex-col items-center justify-center text-center px-6">
            ...
            <button
                onClick={() => navigate("/")}
                className="px-8 py-4 bg-violet-600 text-white font-bold rounded-2xl shadow-xl shadow-violet-500/20 hover:bg-violet-700 hover:-translate-y-1 transition-all"
            >
                Explore Products
            </button>
        </div>
        ...
        <div className="animate-in fade-in slide-in-from-right duration-500 bg-white rounded-[32px] p-8 lg:p-12 shadow-sm border border-gray-100">
            <div className="flex items-center justify-between mb-10">
                ...
                <div className="flex items-center gap-3">
                    <span className="text-sm font-bold text-violet-600 bg-violet-50 px-4 py-1.5 rounded-full">Seller Mode</span>
                </div>
            </div>

            <div className="bg-gradient-to-br from-violet-600 to-purple-800 rounded-[24px] p-10 text-white mb-10 shadow-xl shadow-violet-500/20 relative overflow-hidden group">
                ...
                <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-violet-400/20 rounded-full blur-3xl group-hover:scale-125 transition-transform duration-700"></div>

                <div className="relative z-10">
                    <h3 className="text-3xl font-black mb-4 leading-tight">Start Your Business <br />Journey with Us</h3>
                    <p className="text-violet-100 mb-8 max-w-md font-medium text-lg leading-relaxed">
                        List your products on ShopSphere and reach millions of customers worldwide.
                        Safe payments, easy shipping, and low commission.
                    </p>
                    <button className="px-8 py-4 bg-white text-violet-600 font-black rounded-2xl shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all flex items-center gap-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="p-8 rounded-[24px] border border-gray-100 bg-gray-50/50 hover:bg-white hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center text-violet-600 shadow-sm mb-6 border border-gray-50">
                    ...
                    <button className="text-violet-600 font-bold flex items-center gap-2 hover:gap-3 transition-all">
                        View Products <FaChevronRight size={12} />
                    </button>
                </div>

                <div className="p-8 rounded-[24px] border border-gray-100 bg-gray-50/50 hover:bg-white hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center text-purple-600 shadow-sm mb-6 border border-gray-50">
                        <FaWallet size={24} />
                    </div>
                        ...
                        <div className="bg-white rounded-[32px] p-8 shadow-sm border border-gray-100 mb-6 text-center">
                            <div className="relative inline-block mb-6">
                                <div className="w-28 h-28 bg-gray-200 rounded-full overflow-hidden mx-auto border-4 border-white shadow-xl">
                                    ...
                                    <div className="w-full h-full bg-gradient-to-br from-violet-700 to-purple-800 flex items-center justify-center text-white text-4xl font-black">
                            ...
                            {sidebarItems.map((item) => (
                                <button
                                    ...
                                    className={`flex items-center gap-4 w-full px-6 py-4.5 rounded-2xl text-[13px] font-black tracking-tight transition-all duration-300 ${activeTab === item.id
                                        ? "bg-gradient-to-r from-violet-600 to-purple-600 text-white shadow-2xl shadow-purple-500/25"
