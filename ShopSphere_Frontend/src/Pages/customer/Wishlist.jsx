            ...
            {wishlist.map((item, index) => (
              ...
              >
                ...
                <div className="relative overflow-hidden bg-gradient-to-br from-pink-100 to-red-100 h-48 flex items-center justify-center">
                  ...
                  />
                  {/* Heart Badge */}
                  <div className="absolute top-4 right-4 bg-red-500 text-white rounded-full p-2.5 shadow-lg animate-pulse">
                    <FaHeart size={18} />
                  </div>
                </div>
                ...
                <div className="p-6">
                  ...
                  {/* Price */}
                  <div className="text-2xl font-bold bg-gradient-to-r from-red-600 to-pink-600 bg-clip-text text-transparent mb-6">
                    ₹{item.price}
                  </div>
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      className="flex-1 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white font-semibold py-2.5 px-4 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2 transform hover:scale-[1.02] active:scale-[0.98]"
                    >
                      <FaShoppingCart />
                      Add to Cart
                    </button>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
              <div className="w-24 h-24 bg-red-50 rounded-full flex items-center justify-center mx-auto mb-6">
                <FaHeart size={48} className="text-red-200" />
              </div>
              ...
              <Link
                to="/"
                className="inline-flex items-center gap-2 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white font-bold py-3 px-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 active:scale-95"
              >
